...
import center from '@/views/center'
    ...
    import minshu from '@/views/modules/minshu/list'
    ...
    import dictionaryMinshu from '@/views/modules/dictionaryMinshu/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryMinshu',
        name: '民俗类型',
        component: dictionaryMinshu
    }
    ,{
        path: '/dictionaryNews',
        name: '公告类型',
